...
REM ----- Office 2021 Standard -----
:office2021std
echo ----------------------------
echo 已選擇 Office 2021 Standard
echo ----------------------------
echo.
...
:office2021proplus
echo -------------------------------------
echo 已選擇 Office 2021 Professional Plus
echo -------------------------------------
echo.
...
echo.
echo 正在安裝產品金鑰...
%systemroot%\system32\cscript "%ProgramFiles%\Microsoft Office\office16\ospp.vbs" /inpkey:4YV2J-VNG7W-YGTP3-443TK-TF8CP
echo.
echo 正在啟用 Office...
%systemroot%\system32\cscript "%ProgramFiles%\Microsoft Office\office16\ospp.vbs" /act
echo.
...
echo.
echo 正在安裝產品金鑰...
%systemroot%\system32\cscript "%ProgramFiles(x86)%\Microsoft Office\office16\ospp.vbs" /inpkey:4YV2J-VNG7W-YGTP3-443TK-TF8CP
echo.
echo 正在啟用 Office...
%systemroot%\system32\cscript "%ProgramFiles(x86)%\Microsoft Office\office16\ospp.vbs" /act
echo.
